              ...
              <View style={styles.settingsCard}>
                ...
                {pushStatus === "web-ready" && household && (
                  <TouchableOpacity style={styles.notificationButton} onPress={async () => {
                    ...
                    setPushStatus(await enableWebPushNotifications(household.householdId, household.userId));
                  }}><Text style={styles.notificationButtonText}>Activar avisos</Text></TouchableOpacity>
                )}
              </View>
            </>
          )}
